...
public class MainPaggerNew extends FragmentActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		FoodDatabase.insertFood(3, "ข้าวซอย", 154, 5.8, 10.6, 8.9, 25, 0, 0,
				0, 61, 1, 5, 1, 5, 0, 1);
		...
		FoodDatabase.insertFood(7, "ส้มตำ", 85, 3.7, 2.1, 12.8, 71, 0, 0, 0,
				64, 2, 7, 1, 5, 0, 1);
		...
		FoodDatabase.insertFood(10, "ข้าวหมูกรอบ", 490, 20.4, 21.8, 54.6, 0,
				0, 0, 0, 0, 2, 6, 0, 1, 0, 1);
		...
		FoodDatabase.insertFood(15, "หมูปิ้ง", 72, 6.8, 2.5, 5.6, 0, 0, 0,
				0, 0, 1, 4, 0, 1, 0, 1);
		...
		FoodDatabase.insertFood(19, "สลัดผัก", 92, 1, 6.4, 7.6, 0, 0, 0, 0,
				0, 3, 12, 0, 1, 0, 2);
		FoodDatabase.insertFood(20, "ราดหน้า", 506, 16.5, 21.8, 60.9, 89, 61.1,
				497, 1753, 190, 2, 7, 0, 3, 1, 3);
		FoodDatabase.insertFood(21, "ไข่ดาว", 160, 12.3, 11.7, 1.4, 126, 0,
				0, 0, 204, 3, 3, 0, 0, 1, 1);
